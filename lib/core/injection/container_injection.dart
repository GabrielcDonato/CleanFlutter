...
import 'package:clean_architecture_experts_club/features/auth/presenter/controllers/login_controller.dart';
...
class ContainerInjection {
  static void setup() {
    ...
    i.registerLazySingleton<DoLoginDataSource>(() => DoLoginDataSourceApi(i.get()));
    i.registerLazySingleton<DoLoginRepository>(() => DoLoginRepositoryImpl(i.get()));
