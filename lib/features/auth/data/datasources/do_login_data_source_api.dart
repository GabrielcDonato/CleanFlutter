...
class DoLoginDataSourceApi implements DoLoginDataSource {
  ...
  @override
  Future<UserModel> doLogin({required String email, required String password}) async {
    try {
      var response = await _dio.post('http://www.api.com/user', data: {"email": email, "password": password});
